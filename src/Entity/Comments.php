...
class Comments
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Articles::class, inversedBy="comments", cascade={"remove"})
     * @ORM\JoinColumn(nullable=false)
     */
    private $acticles;

    /**
     * @ORM\ManyToOne(targetEntity=Comments::class, inversedBy="replies" ,cascade={"remove"}))
     */
    private $parent;
    ...
    public function setActicles(?Articles $acticles): self
    {
